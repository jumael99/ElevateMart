        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2 items-center">
            <div className="relative hidden md:block">
              ...
              <input type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500" placeholder="Search..." />
            </div>
            <button type="button" onClick={() => setIsMenuOpen(!isMenuOpen)} className="md:hidden text-gray-500 hover:bg-lightBlue-600 focus:outline-none focus:ring-4 focus:ring-lightBlue-300 rounded-lg text-sm p-2.5 ml-1">
            ...
            <img src="https://via.placeholder.com/40" className="w-10 h-10 rounded-full ml-4" alt="Profile" />
          </div>
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-lightBlue-500 md:flex-row md:space-x-8 md:mt-0 md:border-0">
              ...
              {userInfo && (
                <li onClick={handleLogout}>
                  <div className="block py-2 px-3 text-black rounded hover:bg-lightBlue-600 md:hover:bg-transparent md:hover:text-blue-800 md:p-0 hover:cursor-pointer">
                    Logout
                  </div>
                </li>
              )}
